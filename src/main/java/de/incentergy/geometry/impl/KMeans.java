 ...
 *
 * [ Edited slightly by Chris James ]
 * [ Original source: https://github.com/JasonAltschuler/KMeansPlusPlus ]
 *************************************************************************/
        ...
        for (int c = 0; c < k; c++) {
            ...
            if (c == 0) {
                ...
                for (int p = 0; p < m; p++) {
                    ...
                    } else if (tempDistance < distToClosestCentroid[p]) {
                        distToClosestCentroid[p] = tempDistance;
                    }
                ...
                for (int j = m - 1; j > 0; j--) {
                    ...
                    if (rand > weightedDistribution[j - 1] / weightedDistribution[m - 1]) {
                        ...
                        // Because of invalid dimension errors, we can't make the forloop go to j2 > -1 when we have
                        // (j2-1) in the loop.
                        choose = 0;
                    }
                }
            ...
            if (n >= 0) System.arraycopy(points[choose], 0, centroids[c], 0, n);
        }
    }
